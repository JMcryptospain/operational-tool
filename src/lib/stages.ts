...
export const STAGE_BADGE_CLASSES: Record<AppStage, string> = {
  mvp: "bg-sky-100 text-sky-800",
  refining: "bg-violet-100 text-violet-800",
  ready_for_mainnet: "bg-amber-100 text-amber-800",
  monetization_setup: "bg-violet-100 text-violet-800",
  launched: "bg-emerald-100 text-emerald-800",
  review: "bg-orange-100 text-orange-800",
  active: "bg-emerald-100 text-emerald-800",
  maintain_only: "bg-zinc-100 text-zinc-800",
